...
class LossHistory():
    ...
    def acc_plot(self):
        ...
        plt.plot(iters, self.acc, 'red', linewidth=1, label='train acc')
        plt.plot(iters, self.val_acc, 'coral', linewidth=1, label='val acc')
        try:
            if len(self.acc) < 25:
                num = 5
            else:
            ...
            plt.plot(iters, scipy.signal.savgol_filter(self.acc, num, 3), 'green', linestyle='--', linewidth=1,
                     label='smooth train loss')
            plt.plot(iters, scipy.signal.savgol_filter(self.val_acc, num, 3), '#8B4513', linestyle='--', linewidth=1,
